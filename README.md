...
<img src="./assets/analytics/workers-invocations.png?v=2026-05-15T16:09:06.213Z" alt="Cloudflare Workers 호출량 그래프 (2026-03-01 ~ 2026-05-15)" width="100%">

<sub>기준 워커: <code>daiso-mcp</code> · 마지막 갱신: 2026-05-16 01:09 KST</sub>
...
서비스별 API 상태를 즉시 확인할 때는 `GET /api/health/checks`를 사용합니다. 이 엔드포인트는 `HEALTH_CHECK_SECRET` 환경 변수가 설정되어 있어야 하며, 요청에는 `Authorization: Bearer <secret>` 또는 `x-health-check-key: <secret>` 헤더가 필요합니다.
