...
<h3>Cloudflare Workers 호출량 (2026-06-22 ~ 2026-07-21, 30일)</h3>

<img src="./assets/analytics/workers-invocations.png?v=2026-07-21T15:52:56.741Z" alt="Cloudflare Workers 호출량 그래프 (2026-06-22 ~ 2026-07-21)" width="100%">

<sub>기준 워커: <code>daiso-mcp</code> · 마지막 갱신: 2026-07-22 00:52 KST</sub>
...
```bash
curl -H "Authorization: Bearer $HEALTH_CHECK_SECRET" \
  "https://mcp.aka.page/api/rate-limit/stats?from=2026-07-20&to=2026-07-22&service=cgv"
