...
export const COMMAND_OPTION_ALLOWLISTS = {
  ...
  'cgv-theaters': ['help', 'json', 'keyword', 'regionCode', 'playDate', 'lat', 'lng', 'limit'],
  'cgv-movies': ['help', 'json', 'keyword', 'playDate', 'theaterCode', 'movieCode', 'lat', 'lng'],
  'cgv-timetable': [
    'help',
    'json',
    'keyword',
  ...
  'seveneleven-products': ['help', 'json', 'query', 'page', 'size', 'sort'],
  'seveneleven-stores': ['help', 'json', 'keyword', 'limit'],
