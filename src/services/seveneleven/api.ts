...
export const SEVENELEVEN_API = {
  ...
  SEARCH_STORE_PATH: '/api/v1/open/search/store',
  SEARCH_POPWORD_PATH: '/api/v1/open/search/popword',
  PRODUCT_SEARCH_STOCK_PATH: '/api/v1/open/product/search/stock',
  STOCK_SEARCH_STORES_PATH: '/api/v1/open/stock/search/stores',
  REAL_STOCK_MULTI_PATH: '/api/v1/open/real-stock/multi',
