...
export const ACTION_QUERY_DEFINITIONS: ActionQueryDefinition[] = [
  { action: 'daisoSearchProducts', summary: '다이소 제품 검색', targetPath: '/api/daiso/products' },
  {
    ...
    summary: '다이소 제품 상세 조회',
    targetPath: '/api/daiso/products/:productId',
    pathParam: 'productId',
  },
  { action: 'daisoFindStores', summary: '다이소 매장 검색', targetPath: '/api/daiso/stores' },
  {
    action: 'daisoCheckInventory',
    summary: '다이소 재고 조회',
    targetPath: '/api/daiso/inventory',
  },
  {
    action: 'daisoGetDisplayLocation',
    summary: '다이소 진열 위치 조회',
    targetPath: '/api/daiso/display-location',
  },
  {
    action: 'oliveyoungSearchProducts',
    summary: '올리브영 상품 검색',
    targetPath: '/api/oliveyoung/products',
  },
  {
    action: 'oliveyoungFindStores',
    summary: '올리브영 매장 검색',
    targetPath: '/api/oliveyoung/stores',
  },
  {
    action: 'oliveyoungCheckInventory',
    summary: '올리브영 재고 조회',
    targetPath: '/api/oliveyoung/inventory',
  },
  ...
  {
    action: 'emart24SearchProducts',
    summary: '이마트24 상품 검색',
    targetPath: '/api/emart24/products',
  },
  {
    action: 'emart24CheckInventory',
    summary: '이마트24 재고 조회',
  ...
  {
    action: 'sevenelevenSearchProducts',
    summary: '세븐일레븐 상품 검색',
    targetPath: '/api/seveneleven/products',
  },
  {
    action: 'sevenelevenSearchStores',
    summary: '세븐일레븐 매장 검색',
    targetPath: '/api/seveneleven/stores',
  },
  {
    action: 'sevenelevenCheckInventory',
    summary: '세븐일레븐 재고 조회',
    targetPath: '/api/seveneleven/inventory',
  },
  {
    action: 'sevenelevenGetPopwords',
    summary: '세븐일레븐 인기 검색어 조회',
    targetPath: '/api/seveneleven/popwords',
  },
  {
    action: 'sevenelevenGetCatalog',
    summary: '세븐일레븐 카탈로그 조회',
  ...
  {
    action: 'megaboxListMovies',
    summary: '메가박스 영화 목록 조회',
    targetPath: '/api/megabox/movies',
  },
  {
    action: 'megaboxGetSeats',
    summary: '메가박스 잔여 좌석 조회',
    targetPath: '/api/megabox/seats',
  },
  {
    action: 'lottecinemaFindTheaters',
    summary: '롯데시네마 지점 검색',
    targetPath: '/api/lottecinema/theaters',
  },
  {
    action: 'lottecinemaListMovies',
    summary: '롯데시네마 영화 목록 조회',
    targetPath: '/api/lottecinema/movies',
  },
  {
    action: 'lottecinemaGetSeats',
    summary: '롯데시네마 잔여 좌석 조회',
    targetPath: '/api/lottecinema/seats',
  },
...
export const ACTION_QUERY_ACTIONS = ACTION_QUERY_DEFINITIONS.map((definition) => definition.action);
...
export function getActionQueryDefinition(action: string): ActionQueryDefinition | undefined {
